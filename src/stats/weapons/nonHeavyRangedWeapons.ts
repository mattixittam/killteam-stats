...
export const nonHeavyRangedWeapons: Weapon[] = [
  ...
  },
  {
    ...
    damage: 2,
    damageCritical: 3,
    specialRules: [specialRules.RNG3, specialRules.LETHAL5],
    criticalRules: [criticalRules.STUN],
    equipment: [],
    type: 'RANGED',
  },
  {
    name: 'Marksman rail rifle',
    profile: 'Standard',
    attackDice: 4,
    damage: 4,
    damageCritical: 4,
    specialRules: [specialRules.AP1, specialRules.LETHAL5],
  ...
  },
  {
    ...
    damage: 3,
    damageCritical: 3,
    specialRules: [specialRules.AP1, specialRules.SILENT],
    criticalRules: [criticalRules.MW2],
    equipment: [],
    type: 'RANGED',
  },
