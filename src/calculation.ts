...
function calculateDamageRanged(weapon: Weapon, weaponSkill: number, defenseProfile: Defenseprofile) {
...
function calculateDamageMelee(weapon: Weapon, weaponSkill: number, defenseProfile: Defenseprofile) {
  let rolledDefenseDice = defenseProfile.defenseDice
